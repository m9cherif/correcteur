CREATE TABLE Eleve (IdEleve INTEGER PRIMARY KEY, Nom VARCHAR(40) NOT NULL,
                    Prenom VARCHAR(40), DateNaiss VARCHAR(15), Classe VARCHAR(10));
CREATE TABLE Matiere (IdMatiere INTEGER PRIMARY KEY, Libelle VARCHAR(30) NOT NULL,
                      Coefficient INTEGER);
CREATE TABLE Note (IdNote INTEGER, IdEleve INTEGER, IdMatiere INTEGER,
                   Valeur REAL, DateEval VARCHAR(15),
