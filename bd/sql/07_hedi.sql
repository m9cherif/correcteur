CREATE TABLE Eleve (IdEleve INTEGER PRIMARY KEY, Nom_Eleve VARCHAR(40) NOT NULL,
                    Prenom VARCHAR(40), Adresse VARCHAR(60), DateNaiss DATE,
                    Classe VARCHAR(10));
...
INSERT INTO Eleve VALUES (1,'Belhaj','Amina','Tunis','2008-03-12','3A'),(2,'Karimi','Omar','Sfax','2008-07-01','3A'),(3,'Nasri','Lina','Sousse','2008-11-23','3B');
...
CREATE VIEW R2_ElevesEnEchec AS
  SELECT Nom_Eleve, Prenom FROM Eleve e
  WHERE (SELECT AVG(Valeur) FROM Note WHERE IdEleve=e.IdEleve) < 10;
CREATE VIEW R3_NotesInformatique AS
  SELECT e.Nom_Eleve, n.Valeur FROM Note n JOIN Eleve e ON e.IdEleve=n.IdEleve
